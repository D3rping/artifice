...
public class ArtificeResourcePackProfile extends ClientResourcePackProfile {
    ...
    public ArtificeResourcePackProfile(boolean optional, boolean visible, ResourcePackProfile wrapping) {
        super(
            wrapping.getName(),
            !optional,
